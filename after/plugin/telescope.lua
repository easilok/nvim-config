...
telescope.setup({defaults = {prompt_prefix = " >", color_devicons = true, layout_strategy = "vertical", layout_config = {vertical = {width = 0.8, prompt_position = "bottom"}}, mappings = {i = {["<C-t>"] = action_layout.cycle_layout_next}, n = {["<C-t>"] = action_layout.cycle_layout_next}}}})
